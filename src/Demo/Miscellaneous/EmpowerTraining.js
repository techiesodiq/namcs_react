...
const EmpowerTraining = () => {
	return (
		<div>
			<Card>
				<Card.Header>
					<Card.Title as="h5">Empowerment Trainings</Card.Title>
					<span className="d-block m-t-5">
						Stay connected with our empowerment training opportunities
					</span>
				</Card.Header>
				<Card.Body>
					<Table responsive>
...
export default EmpowerTraining;
