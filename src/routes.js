...
const DashboardDefaultAgent = React.lazy(() =>
	import("./Demo/Dashboard/DefaultAgent")
);
const DashboardDefaultAdmin = React.lazy(() =>
	import("./Demo/Dashboard/DefaultAdmin")
);
const DashboardDefaultManagement = React.lazy(() =>
	import("./Demo/Dashboard/DefaultManagement")
);
...
const MessageForm = React.lazy(() => import("./Demo/Forms/MessageForm"));
...
const routes = [
	...
	{
		path: "/dashboard/default-agent",
		exact: true,
		name: "DefaultAgent",
		component: DashboardDefaultAgent,
	},
	{
		path: "/dashboard/default-admin",
		exact: true,
		name: "DefaultAdmin",
		component: DashboardDefaultAdmin,
	},
	{
		path: "/dashboard/default-management",
		exact: true,
		name: "DefaultManagement",
		component: DashboardDefaultManagement,
	},
	{
		path: "/basic/button",
		exact: true,
